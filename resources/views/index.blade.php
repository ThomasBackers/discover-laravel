...
@section('content')
  ...
  <div class="text-center py-15">
    ...
    <p class="m-auto w-4/5 text-gray-500">
      Lorem ipsum dolor, sit amet consectetur adipisicing elit.
      Saepe expedita atque odit, itaque eos quas rem, reiciendis
      molestiae a ad perferendis.
    </p>
  </div>
    ...
    <div class="flex bg-yellow-700 text-gray-100 pt-10">
      <div class="m-auto pt-4 pb-16 sm:m-auto w-4/5 block">
        ...
        <h3 class="text-xl font-bold py-10">
          Lorem ipsum dolor sit amet consectetur adipisicing elit.
          Doloribus esse, incidunt odit hic ex sapiente minima!
          Quaerat similique fuga, ut ipsa ullam tempore veniam
          nesciunt dolore aliquam obcaecati sed cumque.
        </h3>
